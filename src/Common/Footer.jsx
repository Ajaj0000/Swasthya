...
import { FaInstagram, FaRegClock, FaPhoneAlt, FaArrowRight, FaLongArrowAltUp, FaHeadset } from "react-icons/fa";
          ...
          <div className="footer-row">
            ...
            <div className="second-content">
              <div className="link-footer">
                ...
                <div className="footer-list">
                  <ul>
                    <li><Link to="/"><span><FaArrowRight /></span> Home</Link></li>
                    <li><Link to="/about"><span><FaArrowRight /></span> About Us</Link></li>
                    <li><Link to="/covid-19"><span><FaArrowRight /></span> COVID-19 Care</Link></li>
                    <li><Link to="/photo"><span><FaArrowRight /></span> Photo Gallery</Link></li>
                    <li><Link to="/video"><span><FaArrowRight /></span> Video Gallery</Link></li>
                    <li><Link to="/faq"><span><FaArrowRight /></span> FAQs</Link></li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="third-content">
              <div className="third-footer-link">
                ...
                <div className="footer-list">
                  <ul>
                    <li><Link to="/treatment"><span><FaArrowRight /></span> Diabetes</Link></li>
                    <li><Link to="/treatment"><span><FaArrowRight /></span> High BP</Link></li>
                    <li><Link to="/treatment"><span><FaArrowRight /></span> Heart Disease</Link></li>
                    <li><Link to="/treatment"><span><FaArrowRight /></span> Arthritis & Joint Pain</Link></li>
                    <li><Link to="/treatment"><span><FaArrowRight /></span> Headache</Link></li>
                    <li><Link to="/treatment"><span><FaArrowRight /></span> Anemia</Link></li>
                    <li><Link to="/treatment"><span><FaArrowRight /></span> Fever</Link></li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="fourth-content">
              <div className="fourth-link">
                ...
                <div className="fourth-contect-no">
                  ...
                  <li><span className="fa"><SlEnvolope /></span><a href="/">clinics@hotmail.com</a></li>
                </div>
